...
public class resultNext extends AppCompatActivity {
    ...
    public void setTextForBoth() {
        ...
        resultOppoName.setText(oppoNameByPref + " guess " + jsonOppoGuess);
    }
    ...
    public void setResult() {
        ...
        try {
            if (jsonOppoGuess == plusTotal) {     //op win
                resultMiddle.setBackgroundResource(R.drawable.opwinani);
                ...
                btnCon.setText("PLAY AGAIN >>");
                btnQuit.setText("QUIT >>");

                insertDB("lose"); // oppo win == user lose? i think

                lose = MediaPlayer.create(getApplicationContext(), R.raw.sound_lose);
                lose.start();

            } else if (jsonOppoGuess != plusTotal) { //op lose
                resultMiddle.setBackgroundResource(R.drawable.oploseani);
    ...
    public void btnResult(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnNext:
                i = new Intent(resultNext.this, choose.class);
            ...
            case R.id.btnCon:
                i = new Intent(resultNext.this, starting.class);
            ...
            case R.id.btnQuit:
                i = new Intent(resultNext.this, MainActivity.class);
